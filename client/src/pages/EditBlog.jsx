...
export default function EditBlog({ isAddBlog }) {
    ...
    if (isAddBlog) {
        if (onPreviewPage === undefined) {
            removeLocalBlogData()
            window.location.reload()
            setOnPreviewPage(false)
        }
    } else {
        setOnAddPage(false)
    }
    ...
    // console.log(isAddBlog, "================")
    setOnAddPage(isAddBlog)
    // if (onAddPage === undefined) {
    // }
